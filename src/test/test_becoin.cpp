...
#define BOOST_TEST_MODULE BeCoin Test Suite

#include "test_becoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_becoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
