...
#if defined(NDEBUG)
# error "BeCoin cannot be compiled without assertions."
#endif
...
CFeeRate minRelayTxFee = CFeeRate(500);
...
const string strMessageMagic = "BeCoin Signed Message:\n";
