...
/** BeCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BeCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BeCoinUnits(QObject *parent);

    /** BeCoin units.
      @note Source: https://en.becoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BEF,
