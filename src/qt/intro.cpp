...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/becoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BeCoin Core"),
     ...
     * override -datadir in the becoin.conf file in the default data directory
     * (to be consistent with becoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
