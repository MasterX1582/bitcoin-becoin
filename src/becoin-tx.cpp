...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("BeCoin Core becoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  becoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded becoin transaction") + "\n" +
              "  becoin-tx [options] -create [commands]   " + _("Create hex-encoded becoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded becoin transaction
