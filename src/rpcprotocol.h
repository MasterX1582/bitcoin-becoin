...
#ifndef BECOIN_RPCPROTOCOL_H
#define BECOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! BeCoin is not connected
