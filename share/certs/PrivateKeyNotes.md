...
unlocked to sign the BeCoin-Qt.app bundle.
...
allowing somebody to distribute a BeCoin-Qt.app or becoin-qt-setup.exe with a valid
...
that the becoin-qt.exe file inside the installer had not been tampered with.
