...
This document provides guidelines for internationalization of the BeCoin Core software. 
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `becoin_en.ts` remains unchanged.
