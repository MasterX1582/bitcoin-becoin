BeCoin Core version 0.9.4 is now available from:

  https://becoin.org/bin/0.9.4/
...
this update is incompatible with the BeCoin system and could lead to consensus
forks.

BeCoin Core released binaries from https://becoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~becoin/+archive/ubuntu/becoin
- A third-party or self-compiled BeCoin Core

upgrade to BeCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
