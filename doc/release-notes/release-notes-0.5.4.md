BeCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/becoin/files/BeCoin/becoin-0.5.4/
...
http://gitorious.org/becoin/becoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BeCoin-Qt notifications under Growl 1.3.
Increase required age of BeCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBeCoin properly when installing BeCoin-Qt over it. (Windows)
