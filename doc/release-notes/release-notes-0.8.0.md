BeCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/becoin/files/BeCoin/becoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BeCoin
...
New/changed settings (command-line or becoin.conf file)
--------------------------------------------------------
