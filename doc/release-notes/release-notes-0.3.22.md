Download URL: https://sourceforge.net/projects/becoin/files/BeCoin/becoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BEF fee schedule (users still pay 0.01 BEF per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #becoin00 - #becoin99
