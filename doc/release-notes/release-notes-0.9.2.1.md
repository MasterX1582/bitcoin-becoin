BeCoin Core version 0.9.2.1 is now available from:

  https://becoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BEF to 0.01 BEF
...
- Fix "Start becoin on system login"
