...
###   This script attempts to download the signature file SHA256SUMS.asc from becoin.org
...
WORKINGDIR="/tmp/becoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://becoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://becoin.org/bin/"
VERSIONPREFIX="becoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'becoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[becoin-]<version>-[rc[0-9]] (example: becoin-0.9.2-rc1)"
   echo "wget output:"
