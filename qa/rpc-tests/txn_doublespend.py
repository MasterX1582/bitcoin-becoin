...
class TxnMallTest(BeCoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BEF:
        ...
        # First: use raw transaction API to send 1240 BEF to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BEF coin each
        ...
        # Node0's balance should be starting balance, plus 50BEF for another
        ...
        # Node0's total balance should be starting balance, plus 100BEF for 
