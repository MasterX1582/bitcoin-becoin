# mininode.py - BeCoin P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a becoin node
...
# Objects that map to becoind objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in becoind indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest"):
        ...
        print 'MiniNode: Connecting to BeCoin Node IP # ' + dstaddr + ':' \
            + str(dstport)
