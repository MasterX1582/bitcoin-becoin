...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 50bef, node2 has none.
#   d) node0 sends 21 bef to node2, in two transactions (11 bef, then 10 bef).
...
class WalletTest (BeCoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 BEF from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 bef in block rewards plus fees, but
        ...
        # Send 10 BEF with subtract fee from amount
        ...
        # Sendmany 10 BEF with subtract fee from amount
